...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    /home/data/vgilab/jeongeun/MCITlib/configs/data_configs/UCIT/CLEVR-Math.json \
    /home/data/vgilab/jeongeun/MCITlib/configs/train_configs/SEFE/LLaVA/UCIT/train/task5.json
