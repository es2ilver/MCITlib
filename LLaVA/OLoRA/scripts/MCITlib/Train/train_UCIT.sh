...
bash scripts/MCITlib/Train/Task1.sh \
    ...
    /home/data/vgilab/jeongeun/MCITlib/configs/data_configs/UCIT/ImageNet-R.json \
    /home/data/vgilab/jeongeun/MCITlib/configs/train_configs/OLoRA/LLaVA/UCIT/train/task1.json
